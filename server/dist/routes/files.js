...
router.get('/assignments/:assignmentId/folders', async (req, res) => {
    try {
...
router.post('/assignments/:assignmentId/folders', async (req, res) => {
    try {
...
router.post('/folders/:folderId/files', upload.single('file'), async (req, res) => {
    try {
        if (!req.file)
